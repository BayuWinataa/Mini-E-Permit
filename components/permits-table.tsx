...
import { PermitUserModal } from '@/components/permit-user-modal';
...
const col = createColumnHelper<PermitRow>();
...
const columns = [
	...
	col.display({
		id: 'aksi',
		header: 'Aksi',
		cell: (info) => <PermitUserModal permit={info.row.original} />,
	}),
];
...
export function PermitsTable({ data }: Props) {
	'use no memo';
